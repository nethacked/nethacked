...
%.lp
\item[\tb{X}]
Toggle two-weapon combat on or off.  Note that you must use suitable weapons
...
%.lp
\item[\ib{confirm_locking}]
Have user confirm when locking or unlocking a door or single container
(default on).
%.lp
\item[\ib{DECgraphics}]
